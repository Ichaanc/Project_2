...
document.querySelector(".js-formula-button").addEventListener("click", () => {
  plankton("sound/plankton.wav");
  playGame("formula");
});

document.querySelector(".js-burger-button").addEventListener("click", () => {
  sponge("sound/spongebob.wav");
  playGame("burger");
});

document.querySelector(".js-money-button").addEventListener("click", () => {
